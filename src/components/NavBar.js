        ...
        >
            ...
            <div className='w-full flex justify-between items-center lg:hidden'>
                ...
                <nav className='flex items-center justify-center flex-wrap'>
                    <motion.a
                        href='https://github.com/bryanbuitrago'
                        target={'_blank'}
                        whileHover={{ y: -2 }}
                        whileTap={{ scale: 0.9 }}
                        className='w-6 mr-3'
                    ...
                    <motion.a
                        href='https://www.linkedin.com/in/bryan-buitrago-1229a3105/'
                        target={'_blank'}
                        whileHover={{ y: -2 }}
                        whileTap={{ scale: 0.9 }}
                        className='w-6 mr-3'
                    ...
                    <button
                        ...
                        className={`ml-3 flex items-center justify-items-center rounded-full p-1 
            ...
            {
                isOpen ?
                    <motion.div className='min-w-[70vw] flex flex-col justify-between z-30 
