...
const FeaturedProject = ({ type, title, summary, img, link, github }) => {
    return (
        ...
        border border-solid border-dark bg-light shadow-2xl p-12 relative rounded-br-2xl
         dark:bg-dark dark:border-light lg:flex-col lg:p-8 xs:rounded-br-3xl xs:p-4'>
            <div className='absolute top-0 -right-3 -z-10 w-[101%] h-[103%] rounded-[2.5rem]
             bg-dark rounded-br-3xl dark:bg-light dark:rounded-br-3xl' />
            <Link href={link} tartget='_blank'
    ...
    return (
        ...
        >
            <div className='absolute top-0 -right-3 -z-10 w-[101%] h-[103%] rounded-[2rem]
             bg-dark rounded-br-3xl dark:bg-light md:-right-2 xs:h-[102%]
            ...
            <div className='w-full flex flex-col items-start justify-between mt-4'>
                ...
                <div className='w-full mt-2 flex items-center justify-between'>
                    ...
                    >Visit</Link>
                    <Link href={github} target='_blank' className='w-8 md:w-8'>
                        <GithubIcon />
                    </Link>
                </div>
            </div>
